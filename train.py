...
torch.save(model.state_dict(), "Results/ecg_model_patient_split.pth")
...
with open("Results/patient_split_results.json", "w") as f:
...
plt.ylabel("Actual")
plt.title("Patient-wise Split Confusion Matrix")
